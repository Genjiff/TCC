...
interruptivo das notificações, o que pode ser conseguido utilizando contexto, como sinalizam alguns autores \cite{ho2005using}
\cite{kern2003context} \cite{iqbal2010notifications}.
