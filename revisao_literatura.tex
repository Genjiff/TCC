...
que pessoas lembram melhor dos detalhes de tarefas que não foram interrompidas. \citeonline{zijlstra1999temporal} conclui que
pessoas cometem mais erros em tarefas após uma interrupção. \citeonline{gillie1989makes} afirma que as pessoas executam tarefas
...
Trabalhos anteriores estudaram os efeitos da execução de tarefas concorrentes com a direção. \citeonline{monk2004recovering} cita
...
Em paralelo a este fato, \citeonline{stothart2015attentional} afirma que apenas o ato de receber uma notificação, mesmo que ela não seja
...
\citeonline{oulasvirta2012habits} discorre sobre os hábitos de uso de smartphones. O autor descobriu que o rápido acesso a
...
pela sociedade como problemáticos. \citeonline{iqbal2010notifications} conclui em seu estudo que usuários valorizam o sentimento
...
\citeonline{park2016integrated} desenvolveu um sistema integrado com direção veicular para conduzir estudos de experiência
...
\citeonline{eren2012estimating} apresenta um sistema para estimar o comportamento na direção de motoristas como seguro ou
...
resultados corretos em 14 casos de 15. \citeonline{johnson2011driving} apresenta um sistema semelhante também utilizando
...
humana em um dado momento. \citeonline{fogarty2005predicting} construiu um modelo que utiliza sensores de áudio e vídeo
...
\citeonline{kim2015sensors} desenvolveu um classificador utilizando aprendizagem de máquina para detectar a interruptibilidade
