...
\section{O aplicativo em linhas gerais (título provisório)}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{meu-possante-tela-principal}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{meu-possante-tela-componente}
