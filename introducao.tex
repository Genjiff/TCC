...
o desenvolvimento de uma biblioteca que detecte momentos oportunos e inoportunos para notificação de motoristas, utilizando
apenas sensores de smartphone.

A biblioteca supracitada será responsável por gerenciar o momento de entrega de certas notificações ao dispositivo. Ao incluí-la no código,
os aplicativos terão a garantia de que suas notificações não estão sendo entregues em momentos indevidos e colocando em risco a vida dos
...
literatura que nos permitam identificá-los utilizando apenas sensores de smartphone. Com estes dados em mãos, uma biblioteca para Android
nativo foi desenvolvida. Por fim, elaboramos um experimento para avaliar a solução proposta.
